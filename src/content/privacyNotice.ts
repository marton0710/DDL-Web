...
export const PRIVACY_NOTICE_HIGHLIGHTS: readonly PrivacyNoticeHighlight[] = [
  {
    title: '会保存登录凭据',
    detail: '使用密码登录或绑定学习平台时，相关密码会加密后保存在服务端。',
  },
  {
    title: '可选功能由您决定',
  ...
  {
    title: '不出售个人信息',
    detail: '也不用于个性化广告，不会向无关第三方提供。',
  },
  {
    title: '随时注销',
    detail: '您可以随时注销账户、停止使用，但请注意，注销操作不可逆。',
  },
]
...
export const PRIVACY_NOTICE_SECTIONS: readonly PrivacyNoticeSection[] = [
  {
    ...
    paragraphs: [
      {
        summary: '身份验证：',
        detail: '为了确认您是重庆邮电大学用户，我们会处理您的统一认证账号、密码、统一认证 Cookie，以及统一认证服务返回的姓名和用户标识。',
      },
      {
        summary: '平台绑定：',
        detail: '当您主动绑定学习平台时，我们会处理该平台要求的账号、密码或统一认证信息，并保存登录后取得的 Cookie。不同平台需要的信息不同，页面会在绑定前向您说明。',
      },
      {
        summary: '作业汇总：',
        detail: '为了汇总作业，我们会保存从已绑定平台同步到的课程名称、作业标题、截止时间、作业链接、所属平台和完成状态。',
      },
      {
        summary: '可选功能与日志：',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      {
        summary: '我们的承诺：',
        detail: '我们不会出售您的个人信息，也不会将其用于个性化广告。除实现您选择的功能、遵守法律规定、响应有权机关依法提出的要求或处理安全事件所必需外，我们不会向无关第三方提供您的信息。',
      },
    ],
  },
  {
    ...
    paragraphs: [
      ...
      {
        summary: '安全边界：',
        detail: '我们会采用与信息风险相适应的传输保护、加密存储、访问控制和权限限制等措施，但任何联网服务都无法承诺绝对安全。请不要把银行卡、常用邮箱、社交账号或其他重要账户的密码设置成与统一认证或作业平台相同。',
      },
      {
        summary: '保存期限：',
      ...
      {
        summary: '安全事件：',
        detail: '如果发生或者可能发生信息泄露、篡改或丢失，我们会及时采取补救措施，并在法律要求的范围内向您说明事件情况、可能影响、已经采取的措施以及您可以采取的防护措施。',
      },
    ],
  },
  {
    ...
    paragraphs: [
      ...
      {
        summary: '注销账户：',
        detail: '如果您不再使用本服务，可以在“我的”页面选择“注销账户”。完成页面确认后，我们会删除您的账号、学习平台绑定、登录凭据、Cookie、同步作业和相关个人信息，且无法恢复；法律法规要求继续保存的记录除外。',
        tone: 'warning',
      },
      {
        summary: '联系我们：',
        detail: '“聚合截止线”项目维护者是本服务的个人信息处理者。如需查询、更正或删除个人信息、撤回授权，或者投诉和报告安全问题，请通过页面提供的反馈入口联系我们。我们会先核验您的身份，再处理请求。',
      },
      {
        summary: '请勿公开敏感信息：',
      ...
      {
        summary: '政策更新：',
        detail: '本说明发生重要变化时，我们会在页面中更新内容和最后更新日期；如果变化会明显影响您的权益，我们会以更醒目的方式提示您，并在法律要求时重新取得您的同意。',
      },
    ],
  },
]
